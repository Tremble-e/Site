...
function startRotatingText() {
    ...
    const switchLabel = () => {
        ...
        // Force un recalcul de style pour que les deux couches commencent
        // exactement dans leur état initial avant la transition croisée.
    ...
    window.setInterval(switchLabel, 3600);
}
