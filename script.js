...
function renderServiceAvailabilityStat() {
    ...
    if (status) status.textContent = available ? 'Disponibles' : 'Indisponibles';
...
function renderAdminServices() {
    ...
    if (previewTitle) previewTitle.textContent = available ? 'Services disponibles' : 'Services indisponibles';
...
function previewAdminServices() {
    ...
    preview.classList.toggle('is-available', available);
    preview.classList.toggle('is-unavailable', !available);
    if (title) title.textContent = available ? 'Services disponibles' : 'Services indisponibles';
