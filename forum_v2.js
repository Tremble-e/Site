...
async function openPrivateGroupCreator() {
    if (!forumState.user) return openAccountModal('login');
    forumV2State.groupSelectedMembers = new Set();
    ...
    try {
        ...
        setTimeout(() => document.getElementById('private-group-create-name')?.focus(), 40);
...
function bindForumV2Events() {
    ...
    ['forumReferenceModal', 'forumAttachmentModal', 'forumHistoryModal', 'privateMessagesModal', 'privateGroupCreateModal', 'privateGroupMembersModal', 'adminV2TopicModal', 'adminV2MessageModal'].forEach(id => {
    ...
    document.addEventListener('keydown', event => {
        ...
        ['forumReferenceModal', 'forumAttachmentModal', 'forumHistoryModal', 'privateMessagesModal', 'privateGroupCreateModal', 'privateGroupMembersModal', 'adminV2TopicModal', 'adminV2MessageModal'].forEach(closeModalById);
    });
}
